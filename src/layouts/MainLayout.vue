    ...
    <q-header elevated class="bg-white text-grey-8" height-hint="64">
      <q-toolbar class="GNL__toolbar">
        ...
        <q-toolbar-title v-if="$q.screen.gt.xs" shrink class="row items-center no-wrap">
          ...
          <span class="q-ml-sm">My first Demo</span>
        </q-toolbar-title>
      ...
      <q-scroll-area class="fit">
        <q-list padding class="text-grey-8">
          ...
          <!-- <q-item class="GNL__drawer-item" v-ripple v-for="link in links1" :key="link.text"  clickable> -->
                   ...
                   <q-item class="GNL__drawer-item" v-ripple v-for="link in links1" :key="link.text" :to="link.path" exact    clickable>
...
export default {
  ...
  setup () {
    ...
    return {
      ...
      byDate,
      links1: [
        { icon: 'web', text: 'demodemo',path:'demo' },
        { icon: 'web', text: 'Top stories',path:'demo1' },
